...
import {FundScript, WithdrawScript} from "../../script/Interactions.s.sol";
...
contract InteractionsTest is StdCheats, Test {
    ...
    function testUserCanFundAndOwnerWithdraw() public {
        ...
        // 下面这种调用会使得assert报错，因为 fundMe.fund() OWNER 调用的
        // FundScript fundScript = new FundScript();
        // fundScript.doFund(address(fundMe));

        WithdrawScript withdrawFundMe = new WithdrawScript();
        withdrawFundMe.doWithdraw(address(fundMe));
